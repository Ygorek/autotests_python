...
from locators.alerts_frame_windows_locators import BrowserWindowPageLocators, AlertsPageLocators
...
class BrowserWindowPage(BasePage):
    ...
    # def check_opened_new_window2(self):
...
class AlertsPage(BasePage):
    ...
    # def alternative_test_alert_appear_5_sec(self):
    #     self.element_is_visible(self.locators.APPEAR_ALERT_BUTTON).click()
    #     time.sleep(5)
    #     try:
    #         alert_window = self.driver.switch_to.alert
